...
<!-- Our Cars -->
            ...
            <br>
			<div class="description">Our sport cars offer an ideal solution between performance and elegance. <br>
			<br>
			Features:<br>
			• min.280HP<br>
			• 4 seats<br>
			• min 3.0 Engine<br>
			• full leather business interieur</div>
			<div id="properties">
